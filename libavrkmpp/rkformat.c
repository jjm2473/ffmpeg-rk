...
static const rkformat rkformats[RK_FORMAT_NR+1] = {
        ...
        { .av = AV_PIX_FMT_RGB24,   .mpp = MPP_FMT_RGB888,          .drm = DRM_FORMAT_RGB888,   .rga = RK_FORMAT_RGB_888},
        { .av = AV_PIX_FMT_BGR24,   .mpp = MPP_FMT_BGR888,          .drm = DRM_FORMAT_BGR888,   .rga = RK_FORMAT_BGR_888},
        { .av = AV_PIX_FMT_RGBA,    .mpp = MPP_FMT_RGBA8888,        .drm = DRM_FORMAT_RGBA8888, .rga = RK_FORMAT_RGBA_8888},
        { .av = AV_PIX_FMT_RGB0,    .mpp = MPP_FMT_RGBA8888,        .drm = DRM_FORMAT_RGBX8888, .rga = RK_FORMAT_RGBX_8888},
        { .av = AV_PIX_FMT_BGRA,    .mpp = MPP_FMT_BGRA8888,        .drm = DRM_FORMAT_BGRA8888, .rga = RK_FORMAT_BGRA_8888},
        { .av = AV_PIX_FMT_BGR0,    .mpp = MPP_FMT_BGRA8888,        .drm = DRM_FORMAT_BGRX8888, .rga = RK_FORMAT_BGRX_8888},
        { .av = AV_PIX_FMT_ARGB,    .mpp = MPP_FMT_ARGB8888,        .drm = DRM_FORMAT_ARGB8888, .rga = RK_FORMAT_ARGB_8888},
        { .av = AV_PIX_FMT_0RGB,    .mpp = MPP_FMT_ARGB8888,        .drm = DRM_FORMAT_XRGB8888, .rga = RK_FORMAT_XRGB_8888},
        { .av = AV_PIX_FMT_ABGR,    .mpp = MPP_FMT_ABGR8888,        .drm = DRM_FORMAT_ABGR8888, .rga = RK_FORMAT_ABGR_8888},
        { .av = AV_PIX_FMT_0BGR,    .mpp = MPP_FMT_ABGR8888,        .drm = DRM_FORMAT_XBGR8888, .rga = RK_FORMAT_XBGR_8888},
