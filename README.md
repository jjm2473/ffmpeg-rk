本项目主要用于支持 RK35XX 平台的硬件转码，例如用于支持 Jellyfin，如果你想在桌面系统使用（例如firefox），或者本项目无法满足你的需求，可以试试 https://github.com/nyanmisaka/ffmpeg-rockchip 或者 https://github.com/hbiyik/FFmpeg/ 。
